					...
					<div class="modal-body">
						...
						<div class="row g-1 pb-2">
							...
							<div class="col-lg-4 col-12">
    							...
    							<select class="form-select form-select-sm" id="studentAssessmentResult" name="studentAssessmentResult" required>
			...
			$.ajax({
		    	...
		    	for(let data of dataList) {
		    		...
		    		$('#studentAssessmentTable > tbody:last').append($('<tr>')
						...
						.append($('<td>').append('<button class="btn btn-sm btn-warning m-1" onclick="onOpenModal(\''+data.assessmentId+'\',\''+data.studentId+'\')">Evaluate</button>'))
					);
				}
		...
		$('#insertForm').submit(function(event){
			...
			if (formValidityStatus) {
				...
				$.ajax({
			    	...
			    	$('#studentAssessmentTable').DataTable().clear().destroy();
