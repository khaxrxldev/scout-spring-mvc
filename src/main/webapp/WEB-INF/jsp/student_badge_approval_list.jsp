<%@ include file="sidebar/sidebar_header.jspf" %>
	...
	<script type="text/javascript">
		...
		function onGetTableData() {
			$.ajax({
				type: "GET",
		        url: "/core/student/badge/approval/pending"
		    	...
		    	for(let data of dataList) {
		    		$('#studentTable > tbody:last').append($('<tr>')
						...
						.append($('<td>').append('<button onclick="window.location.href=\'/core/student/badge/approval/' + data.studentId + '\'" class="btn btn-sm btn-primary m-1">Approve</button>'))
					);
				}
